...
var jic = {
        ...
        compress: function(source_img_obj, quality, output_format, sizeImage){
             ...
             if(sizeImage) {
               cvs.width = sizeImage.width;
               cvs.height = sizeImage.height;
               ctx = cvs.getContext("2d").drawImage(source_img_obj, 0, 0, sizeImage.width, sizeImage.height);
             } else {
