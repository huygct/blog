(function(){
    ...
    function mdtTableDirective(TableDataStorageFactory, mdtPaginationHelperFactory, mdtAjaxPaginationHelperFactory, $mdDialog){
        return {
            restrict: 'E',
            templateUrl: 'app/zzzComponents/table/main/templates/mdtTable.html',
            transclude: true,
            scope: {
                tableCard: '=',
                selectableRows: '=',
            ...
            link: function($scope, element, attrs, ctrl, transclude){
                ...
                function showEditDialog(ev, cellData, rowData){
                    ...
                    if(cellData.attributes.editableField === 'smallEditDialog'){
                        ops.templateUrl = 'app/zzzComponents/table/main/templates/smallEditDialog.html';
                    }else{
                        ops.templateUrl = 'app/zzzComponents/table/main/templates/largeEditDialog.html';
                    }
