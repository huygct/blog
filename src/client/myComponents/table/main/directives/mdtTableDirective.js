(function(){
    ...
    function mdtTableDirective(TableDataStorageFactory, mdtPaginationHelperFactory, mdtAjaxPaginationHelperFactory, $mdDialog){
        return {
            restrict: 'E',
            templateUrl: 'myComponents/table/main/templates/mdtTable.html',
            transclude: true,
            scope: {
                tableCard: '=',
                selectableRows: '=',
            ...
            link: function($scope, element, attrs, ctrl, transclude){
                ...
                function showEditDialog(ev, cellData, rowData){
                    ...
                    if(cellData.attributes.editableField === 'smallEditDialog'){
                        ops.templateUrl = 'myComponents/table/main/templates/smallEditDialog.html';
                    }else{
                        ops.templateUrl = 'myComponents/table/main/templates/largeEditDialog.html';
                    }
